...
export const translations: Record<Language, Translations> = {
  EN: {
    ...
    "admin.pinTooShort": "Password must be at least 4 characters",
  ...
  AR: {
    ...
    "admin.pinTooShort": "يجب أن تكون كلمة المرور 4 أحرف على الأقل",
  ...
  KU: {
    ...
    "admin.pinTooShort": "وشەی نهێنی دەبێت لانیکەم 4 پیت بێت",
